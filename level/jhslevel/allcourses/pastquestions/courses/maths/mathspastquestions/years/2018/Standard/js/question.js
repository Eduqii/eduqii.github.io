...
{
		question: 'If P = {x: x is an even number greater than two and less than or equal to twelve}, list the members of P.',
	...
	{
		question: 'If y = c + bx<sup>2</sup>, find y when c = <sup>14</sup>&frasl;<sub>5</sub>,b=45, c=145, b=<sup>4</sup>&frasl;<sub>5</sub> and x = 2.',
		options: ['3',
		 '4',
		 '6',
		 '7'],
	...
	{
		question: 'The following data show the marks of students in a test:' + '<br />' + '10, 4, 1, 4, 3, 3, 2, 1, 1, 7, 8' + '<br />' + 'If the pass mark is 4, find the number of students who scored more than the pass mark.',
		options: ['1',
		 '2',
		 '3',
		 '4'],
	...
	{
		question: 'The following data show the marks of students in a test:' + '<br />' + '10, 4, 1, 4, 3, 3, 2, 1, 1, 7, 8' + '<br />' + 'Find the mean mark.',
		options: ['3',
		 '4',
		 '7',
		 '8'],
