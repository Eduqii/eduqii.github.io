...
const quiz = [
  {
  	question:'<b>' + 'From the alternatives lettered A to D, choose the one which most suitably completes each sentence.' + '</b>' + '<br />' + '<br />' + 'Salifu was ______ surprised that he could not talk.',
  	options:['enough',
			 'so',
			 'what',
			 'which'],
  ...
  {	
  	question: '<b>' + 'From the alternatives lettered A to D, choose the one which most suitably completes each sentence.' + '</b>' + '<br />' + '<br />' + 'This amount is all _____ I have on me.',
	options:[ 'that',
			  'this',
			  'what',
			  'which'],
  ...
  {
  	question: '<b>' + 'From the alternatives lettered A to D, choose the one which most suitably completes each sentence.' + '</b>' + '<br />' + '<br />' + 'I am told the boy is a friend of _____',
  	options:['he',
			 'him',
			 'his',
			 'he\'s'],
  ...
  {
  	question: '<b>' + 'From the alternatives lettered A to D, choose the one which most suitably completes each sentence.' + '</b>' + '<br />' + '<br />' + 'Rice and beans ______ a good meal for children.',
  	options:[ 'are',
			  'have been',
			  'is',
			  'is being'],
  ...
  {
  	question: '<b>' + 'From the alternatives lettered A to D, choose the one which most suitably completes each sentence.' + '</b>' + '<br />' + '<br />' + 'Yaw is ______ clever to be cheated.',  	
  	options:[ 'quite',
			  'so',
			  'too',
			  'very'],
  ...
  {
  	question: '<b>' + 'From the alternatives lettered A to D, choose the one which most suitably completes each sentence.' + '</b>' + '<br />' + '<br />' + 'The two rivals are fond of insulting_____',		
  	options: ['each other',
			  'one another',
			  'one and the other',
			  'themselves'],
  ...
  {
  	question: '<b>' + 'From the alternatives lettered A to D, choose the one which most suitably completes each sentence.' + '</b>' + '<br />' + '<br />' + 'Of all the pupils in the class, Ekua is ______ ',	 
  	options: [ 'prettier',
			   'prettiest',
			   'the prettier',
			   'the prettiest'],
  ...
  {
  	question: '<b>' + 'From the alternatives lettered A to D, choose the one which most suitably completes each sentence.' + '</b>' + '<br />' + '<br />' + 'It is high time Adzo ______ home.',		
  	options: [ ' came',
			   'comes',
			   'has come',
			   'will come'],
  ...
  {
  	question: '<b>' + 'From the alternatives lettered A to D, choose the one which most suitably completes each sentence.' + '</b>' + '<br />' + '<br />' + 'You should be ______ more careful about what you say.',		
  	options: ['less',
			  'least',
			  'little',
			  'a little'],
  ...
  {
  	question: '<b>' + 'From the alternatives lettered A to D, choose the one which most suitably completes each sentence.' + '</b>' + '<br />' + '<br />' + 'Atsu is looking forward to ______ his friends at the party.',		
  	options: ['see',
			  'seeing',
			  'be seeing',
			  'have seen'],
  ...
  {
  	question: '<b>' + 'From the alternatives lettered A to D, choose the one which most suitably completes each sentence.' + '</b>' + '<br />' + '<br />' + 'The harder you study, ______ your chance of success.',
  		options: ['greater',
				  'greatest',
				  'the great',
				  'the greater'],
  ...
  {
  	question: '<b>' + 'From the alternatives lettered A to D, choose the one which most suitably completes each sentence.' + '</b>' + '<br />' + '<br />' + 'If you had asked me, I _____ you.',
		options: ['will help',
				  'would help',
				  'will have helped',
				  'would have helped'],
  ...
  {
  	question: '<b>' + 'From the alternatives lettered A to D, choose the one which most suitably completes each sentence.' + '</b>' + '<br />' + '<br />' + 'I don\'t really know what you want, _____ I?',		
  	options: ['am',
			  'aren\'t',
			  'do',
			  'did'],
  ...
  {
  	question: '<b>' + 'From the alternatives lettered A to D, choose the one which most suitably completes each sentence.' + '</b>' + '<br />' + '<br />' + 'I will not walk to school with _____ of the boys.',		
  	options: ['each',
			  'either',
			  'everyone',
			  'neither'],
  ...
  {
  	question: '<b>' + 'From the alternatives lettered A to D, choose the one which most suitably completes each sentence.' + '</b>' + '<br />' + '<br />' + 'Jane fell ill _____ measles.',		
  	options: ['at',
			  'by',
			  'of',
			  'with'],
