...
const quiz = [
  {
  	question: 'LEXIS AND STRUCTURE' + '<br />' + '<br />' + '<b>' + 'From the alternatives lettered A to D, choose the one which most suitably completes each sentence' + '</b>' + '<br />' + '<br />' + 'The lion _____ under the tree waiting for its prey.',
  	options:['lie',
 			 'lain',
 			 'lay',
 			 'laid'],
  ...
  {	
  	question: 'LEXIS AND STRUCTURE' + '<br />' + '<br />' + '<b>' + 'From the alternatives lettered A to D, choose the one which most suitably completes each sentence' + '</b>' + '<br />' + '<br />' + 'I wish Ato _____ come to see us tomorrow.',
	options:[ 'will',
			  'is to',
			  'would',
			  'may'],
  ...
  {
  	question: 'LEXIS AND STRUCTURE' + '<br />' + '<br />' + '<b>' + 'From the alternatives lettered A to D, choose the one which most suitably completes each sentence' + '</b>' + '<br />' + '<br />' + 'It\'s high time we _____ the items out.',
  	options:['move',
			 'are moving',
			 'moved',
			 'were moving'],
  ...
  {
  	question: 'LEXIS AND STRUCTURE' + '<br />' + '<br />' + '<b>' + 'From the alternatives lettered A to D, choose the one which most suitably completes each sentence' + '</b>' + '<br />' + '<br />' + 'This amount is all _____ I have on me.',  	
  	options:[ 'what',
			  'that',
			  'which',
			  'this'],
  ...
  {
  	question: 'LEXIS AND STRUCTURE' + '<br />' + '<br />' + '<b>' + 'From the alternatives lettered A to D, choose the one which most suitably completes each sentence' + '</b>' + '<br />' + '<br />' + 'The harder you study, _____ your chance of success.',
		options: ['the great',
				  'greater',
				  'greatest',
				  'the greater'],
  ...
  {
  	question: 'LEXIS AND STRUCTURE' + '<br />' + '<br />' + '<b>' + 'From the alternatives lettered A to D, choose the one which most suitably completes each sentence' + '</b>' + '<br />' + '<br />' + 'Please, I would rather you _____ not disturb me.',  	
  	options:[ 'did',
			  'will',
			  'may',
			  'do'],
  ...
  {
  	question: 'LEXIS AND STRUCTURE' + '<br />' + '<br />' + '<b>' + 'From the alternatives lettered A to D, choose the one which most suitably completes each sentence' + '</b>' + '<br />' + '<br />' + 'That pair of trousers is worn _____',
		options: ['in',
				  'out',
				  'into',
				  'on'],
  ...
  {
  	question: 'LEXIS AND STRUCTURE' + '<br />' + '<br />' + '<b>' + 'From the alternatives lettered A to D, choose the one which most suitably completes each sentence' + '</b>' + '<br />' + '<br />' + 'Atsu is looking forward to _____ his friends at the party.',	 
  	options: [ 'see',
			   'be seeing',
			   'seeing',
			   'have seen'],
  ...
  {
  	question: 'LEXIS AND STRUCTURE' + '<br />' + '<br />' + '<b>' + 'From the alternatives lettered A to D, choose the one which most suitably completes each sentence' + '</b>' + '<br />' + '<br />' + 'The minister is my _____ brother.',		
  	options: [ 'senior',
			   'older',
			   'elder',
			   'junior'],
  ...
  {
  	question: 'LEXIS AND STRUCTURE' + '<br />' + '<br />' + '<b>' + 'From the alternatives lettered A to D, choose the one which most suitably completes each sentence' + '</b>' + '<br />' + '<br />' + 'We have _____ sugar, so we cannot have breakfast.',		
  	options: ['a few',
			  'little',
			  'few',
			  'a little'],
  ...
  {
  	question: 'LEXIS AND STRUCTURE' + '<br />' + '<br />' + '<b>' + 'From the alternatives lettered A to D, choose the one which most suitably completes each sentence' + '</b>' + '<br />' + '<br />' + 'I wouldn\'t say this to ____ ',		
  	options: ['no other',
			  'any other',
			  'nobody',
			  'anyone else'],
  ...
  {
  	question: 'LEXIS AND STRUCTURE' + '<br />' + '<br />' + '<b>' + 'From the alternatives lettered A to D, choose the one which most suitably completes each sentence' + '</b>' + '<br />' + '<br />' + 'This vase is made _____ glass.',		
  	options: ['on',
			  'of',
			  'with',
			  'by'],
  ...
  {
  	question: 'LEXIS AND STRUCTURE' + '<br />' + '<br />' + '<b>' + 'From the alternatives lettered A to D, choose the one which most suitably completes each sentence' + '</b>' + '<br />' + '<br />' + 'Mrs. Akwei is blind _____ the faults of her children.',
		options: ['on',
				  'over',
				  'to',
				  'by'],
  ...
  {
  	question: 'LEXIS AND STRUCTURE' + '<br />' + '<br />' + '<b>' + 'From the alternatives lettered A to D, choose the one which most suitably completes each sentence' + '</b>' + '<br />' + '<br />' + 'Shika was absent yesterday, _____ ?',		
  	options: ['isn\'t she',
			  'has she',
			  'didn\'t she',
			  'wasn\'t she'],
  ...
  {
  	question: 'LEXIS AND STRUCTURE' + '<br />' + '<br />' + '<b>' + 'From the alternatives lettered A to D, choose the one which most suitably completes each sentence' + '</b>' + '<br />' + '<br />' + 'Come and see me tomorrow, _____  you?',
		options: ['shall',
				  'will',
				  'may',
				  'don\'t'],
  ...
  {
  	question: 'LEXIS AND STRUCTURE' + '<br />' + '<br />' + '<b>' + 'From the alternatives lettered A to D, choose the one which most suitably completes each sentence' + '</b>' + '<br />' + '<br />' + 'If Kofi had studied hard, he _____ his examination.',		
  	options: ['would pass',
			  'would be passing',
			  'will be passing',
			  'would have passed'],
  ...
  {
  	question: 'LEXIS AND STRUCTURE' + '<br />' + '<br />' + '<b>' + 'From the alternatives lettered A to D, choose the one which most suitably completes each sentence' + '</b>' + '<br />' + '<br />' + 'The boy likes his _____ dog.',		
...
'Final call to thee\'?' + '<br />' + '<br />' + 'The main character in a play or a novel is called',		
  ...
  {
  	question: '<b>' + 'Read the following extract carefully and answer this questionf' + '</b>' + '<br />' + '<br />' + '\'O incomprehensible God!' + '<br />' + 
'Shall my pilot be' + '<br />' + 
'My inborn stars to that' + 
