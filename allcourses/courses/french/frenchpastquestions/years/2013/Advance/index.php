...
<div id="home" class="flex-column flex-center">
	<h5>Instruction: <br /> This quiz contains two passages (Passage I - Une visite à Papa and Passage II - Après les cours ). To read, click on the passage icon below to toggle it.</h5>
	<h1>Are you Ready?</h1>
