...
-->
  <div class="container" id="containers">
    ...
    <center><h2 class="mt-4">2014 BECE Social Studies Past Questions – Paper Two</h2></center>
    
    <p>1. (a) State the main method for cooking the following foods:
(i) rice
(ii) cake
...
<div class="container" id="containers">    
    <p>DISCLAIMER: ANSWERS PROVIDED ARE ONLY GUIDELINES TO BE EXPANDED, IF REQUIRED, INTO ESSAY FORM FOR FULL MARKS IN THE EXAMINATION.

3. (a) What is boiling as a method of cooking?

(b) State two advantages of boiling as a method of cooking

(c) State two disadvantages of boiling as a method of cooking

(d) List ten food items that can be cooked using the boiling method

(e) List two examples each of food items which can be prepared with the following methods of cooking
...
(f) Plan a two course lunch menu for an adolescent using meat for the main dish and provide a suitable dessert
</p>
  </div><br /><br />
  ...
  <div class="container themed-container"><div class="accordion" id="accordionExample">
    ...
    <div class="container" id="containers">
    <p>DISCLAIMER: ANSWERS PROVIDED ARE ONLY GUIDELINES TO BE EXPANDED, IF REQUIRED, INTO ESSAY FORM FOR FULL MARKS IN THE EXAMINATION.
4. (a) The passage below describes the threading of the sewing machine. Fill in the blank spaces with the appropriate words selected from the list below
...
(h) State two disadvantages of microwave cooking</p>
  </div><br /><br />
