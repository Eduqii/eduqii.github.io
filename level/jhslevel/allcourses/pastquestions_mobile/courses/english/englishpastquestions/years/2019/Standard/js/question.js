...
const quiz = [
  ...
  {	
  	question: '<b>' + 'From the alternatives lettered A to D, choose the one which most suitably completes each sentence.' + '</b>' + '<br />' + '<br />' + 'I saw the dog _____ out of the house.',
	options:[ 'run',
			  'is running',
			  'ran',
			  'was running'],
  ...
  {
  	question: '<b>' + 'From the alternatives lettered A to D, choose the one which most suitably completes each sentence.' + '</b>' + '<br />' + '<br />' + 'Habib goes to school _____ train.',
  	options:['by',
			 'on',
			 'with',
			 'in'],
  ...
  {
  	question: '<b>' + 'From the alternatives lettered A to D, choose the one which most suitably completes each sentence.' + '</b>' + '<br />' + '<br />' + 'This phone is not mine, it is _____ ',
  ...
  {
  	question: '<b>' + 'From the alternatives lettered A to D, choose the one which most suitably completes each sentence.' + '</b>' + '<br />' + '<br />' + 'Their sister wore a _____ dress to the party.',  	
  ...
  {
  	question: '<b>' + 'From the alternatives lettered A to D, choose the one which most suitably completes each sentence.' + '</b>' + '<br />' + '<br />' + 'I wish I _____ my friend next week.',		
  	options: ['can visit',
			  'am visiting',
			  'shall visit',
			  'could visit'],
  ...
  {
  	question: '<b>' + 'From the alternatives lettered A to D, choose the one which most suitably completes each sentence.' + '</b>' + '<br />' + '<br />' + 'Aba took _____ her mother in many ways.',	 
  	options: [ 'after',
			   'up',
			   'on',
			   'by'],
  ...
  {
  	question: '<b>' + 'From the alternatives lettered A to D, choose the one which most suitably completes each sentence.' + '</b>' + '<br />' + '<br />' + 'That girls is allergic _____ dust.',		
  	options: [ 'with',
			   'to',
			   'against',
			   'about'],
  ...
  {
  	question: '<b>' + 'From the alternatives lettered A to D, choose the one which most suitably completes each sentence.' + '</b>' + '<br />' + '<br />' + 'My brother, with his children, _____ travelling to Salaga next week.',		
  	options: ['is',
			  'are',
			  'was',
			  'were'],
  ...
  {
  	question: '<b>' + 'From the alternatives lettered A to D, choose the one which most suitably completes each sentence.' + '</b>' + '<br />' + '<br />' + 'It is high time we  _____  for the meeting.',		
  	options: ['left',
			  'leave',
			  'have to leave',
			  'will leave'],
  ...
  {
  	question: '<b>' + 'From the alternatives lettered A to D, choose the one which most suitably completes each sentence.' + '</b>' + '<br />' + '<br />' + 'The accused person refused to appear before the _____ panel.',		
  	options: ['five-man\'s',
			  'five-man',
			  'five-men',
			  'five-mens'],
  ...
  {
  	question: '<b>' + 'From the alternatives lettered A to D, choose the one which most suitably completes each sentence.' + '</b>' + '<br />' + '<br />' + 'The stories her children told her made her  _____ ',
		options: ['to laugh',
				  'laughing',
				  'laughed',
				  'laugh'],
  ...
  {
  	question: '<b>' + 'From the alternatives lettered A to D, choose the one which most suitably completes each sentence.' + '</b>' + '<br />' + '<br />' + 'They have not bought  _____  of the two prescribed books.',		
  	options: ['neither',
			  'either',
			  'none',
			  'all'],
  ...
  {
  	question: '<b>' + 'From the alternatives lettered A to D, choose the one which most suitably completes each sentence.' + '</b>' + '<br />' + '<br />' + 'The boy found the assignment  _____  to do.',
  ...
  {
  	question: '<b>' + 'From the alternatives lettered A to D, choose the one which most suitably completes each sentence.' + '</b>' + '<br />' + '<br />' + 'The oxen lay on the bare floor, _____ ?',		
  	options: ['didn\'t they',
			  'don\'t they',
			  'didn\'t it',
			  'isn\'t it'],
