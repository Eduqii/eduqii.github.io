...
<html lang="en">
  <head>
    ...
    <title>English Language TextBook · Eduqii v2.0</title>
...
<header class="bd-header bg-dark py-3 d-flex align-items-stretch border-bottom border-dark">
  <div class="container-fluid d-flex align-items-center">
    <h1 class="d-flex align-items-center fs-4 text-white mb-0">
      ...
      <span style="font-variant: small-caps;">English Language</span>
    </h1>
    <a href="../englishpastquestions/years/index.php" class="ms-auto link-light" hreflang="ar"><span style="font-variant: small-caps;">Past Questions</span></a>
  </div>
</header>
<aside class="bd-aside sticky-xl-top text-muted align-self-start mb-3 mb-xl-5 px-2">
  <h2 class="h6 pt-4 pb-3 mb-4 border-bottom">On this page</h2>
  <h2 class="h6 pt-4 pb-3 mb-4 border-bottom"><a href="../englishdictionary.php" target="_blank"><span style="font-variant: small-caps;">English Dictionary</span></a></h2>
