...
<div class="container">
	<div id="game" class="justify-center flex-column">
		<div id="hud">
		 ...
		 <div class="popup" onclick="myFunction()"><span style="font-size: 2.5rem;">BECE 2017 &nbsp; &nbsp;Instruction(s) &nbsp; &nbsp; <span style="font-size: 2.5rem;"><a href="../index.html" class="Exit">Exit</a></span></span>
