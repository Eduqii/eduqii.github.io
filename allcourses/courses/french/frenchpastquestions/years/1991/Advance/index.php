...
<head>
	...
	<title>Quiz | B.E.C.E 1991 v2.0</title>
...
<div id="home" class="flex-column flex-center">
	<h5>Instruction: <br /> This quiz contains a single passage (Passage - UN SOIR AU CINEMA). To read, click on the passage icon below to toggle it.</h5>
	<h1>Are you Ready?</h1>
