...
const quiz = [
  {
  	question: '<b>' + 'From the alternatives lettered A to D, choose the one which most suitably completes each sentence.' + '</b>' + '<br />' + '<br />' + 'John has given ______ smoking',
  	options:['in',
			 'off',
			 'out',
			 'up'],
  ...
  {	
  	question: '<b>' + 'From the alternatives lettered A to D, choose the one which most suitably completes each sentence.' + '</b>' + '<br />' + '<br />' + 'The crowd was _______ large that the Director became frightened.',
	options:[ 'quite',
			  'so',
			  'too',
			  'very'],
  ...
  {
  	question: '<b>' + 'From the alternatives lettered A to D, choose the one which most suitably completes each sentence.' + '</b>' + '<br />' + '<br />' + 'When we got there, the buses _______ left.',
  	options:['are',
			 'had',
			 'have',
			 'were'],
  ...
  {
  	question: '<b>' + 'From the alternatives lettered A to D, choose the one which most suitably completes each sentence.' + '</b>' + '<br />' + '<br />' + 'The book was _______ to me.',  	
  	options:[ 'gave',
			  'given',
			  'giving',
			  'to give'],
  ...
  {
  	question: '<b>' + 'From the alternatives lettered A to D, choose the one which most suitably completes each sentence.' + '</b>' + '<br />' + '<br />' + 'Auntie is the lady to ______ I gave the list.',  	
  	options:[ 'who',
			  'whom',
			  'which',
			  'whose'],
  ...
  {
  	question: '<b>' + 'From the alternatives lettered A to D, choose the one which most suitably completes each sentence.' + '</b>' + '<br />' + '<br />' + 'He\'s your friend, ______ ?',		
  	options: ['doesn\'t he',
			  'does he',
			  'isn\'t he',
			  'isn\'t it'],
  ...
  {
  	question: '<b>' + 'From the alternatives lettered A to D, choose the one which most suitably completes each sentence.' + '</b>' + '<br />' + '<br />' + 'Kay: You didn\'t go to Accra did you?' + '<br />' + 'Lee: _______ .',
	 options: [ 'No, I did',
			    'No, I didn\'t',
			    'Yes, did I',
				'Yes, I didn\'t'],
  ...
  {
  	question: '<b>' + 'From the alternatives lettered A to D, choose the one which most suitably completes each sentence.' + '</b>' + '<br />' + '<br />' + 'You had better _______ now.',		
  	options: [ 'left',
			   'leave',
			   'be leaving',
			   'to leave'],
  ...
  {
  	question: '<b>' + 'From the alternatives lettered A to D, choose the one which most suitably completes each sentence.' + '</b>' + '<br />' + '<br />' + 'Kwame asked his friend to ______ him a pen.',
		options: ['borrow',
			  	  'excuse',
				  'lend',
				  'spare'],
  ...
  {
  	question: '<b>' + 'From the alternatives lettered A to D, choose the one which most suitably completes each sentence.' + '</b>' + '<br />' + '<br />' + 'She ended the letter, _______ ',		
  ...
  {
  	question: '<b>' + 'From the alternatives lettered A to D, choose the one which most suitably completes each sentence.' + '</b>' + '<br />' + '<br />' + '\'Yes, _______ a book,\' he said.',
		options: ['is',
				  'its',
				  'it\'s',
				  'it'],
  ...
  {
  	question: '<b>' + 'From the alternatives lettered A to D, choose the one which most suitably completes each sentence.' + '</b>' + '<br />' + '<br />' + 'I know you are much _______ than Esi.',		
  	options: ['tall',
			  'taller',
			  'tallest',
			  'the taller'],
  ...
  {
  	question: '<b>' + 'From the alternatives lettered A to D, choose the one which most suitably completes each sentence.' + '</b>' + '<br />' + '<br />' + 'Neither John nor his friend, ______  a play to the end.',
		options: ['watch',
				  'watches',
				  'was watching',
				  'were watching'],
  ...
  {
  	question: '<b>' + 'From the alternatives lettered A to D, choose the one which most suitably completes each sentence.' + '</b>' + '<br />' + '<br />' + 'Araba and Osei are a devoted couple who love _______ ',		
  	options: ['each other',
			  'one another',
			  'themselves',
			  'the other'],
