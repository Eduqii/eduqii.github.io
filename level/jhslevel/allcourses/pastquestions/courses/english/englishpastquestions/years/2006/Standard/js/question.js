...
'All the pupils are ' + '<u>' + 'skilful' + '</u>' + ' at using the computer',
options: ['interested',
 'lazy',
 'expert',
 'happy'],
...
question: 'SECTION B' + '<br />' + '<br />' +
'<b>' + 'Choose from the alternatives lettered A to D the one which is nearest in meaning to the underlined word in each sentence' + '</b>' + '<br />' + '<br />' +
'The parent who donated the books to our school wants to remain ' + '<u>' + 'anonymous' + '</u>',
options: ['quiet',
 'rich',
 'unimportant',
 'unknown'],
...
question: 'SECTION B' + '<br />' + '<br />' +
'<b>' + 'Choose from the alternatives lettered A to D the one which is nearest in meaning to the underlined word in each sentence' + '</b>' + '<br />' + '<br />' +
'Kofi is the most ' + '<u>' + 'popular' + '</u>' + ' man in the village.',
options: ['wanted',
 'respected',
 'liked',
 'feared'],
...
question: 'SECTION B' + '<br />' + '<br />' +
'<b>' + 'Choose from the alternatives lettered A to D the one which is nearest in meaning to the underlined word in each sentence' + '</b>' + '<br />' + '<br />' +
'The PTA meeting has been ' + '<u>' +  'postponed.' + '</u>',
options: ['delayed ',
 'cancelled ',
 'announced ',
 'held'],
...
question: 'SECTION B' + '<br />' + '<br />' +
'<b>' + 'Choose from the alternatives lettered A to D the one which is nearest in meaning to the underlined word in each sentence' + '</b>' + '<br />' + '<br />' +
'Issah is gentle but his sister is ' + '<u>' + 'arrogant' + '</u>',
options: ['shy',
 'proud ',
 'clever ',
 'tough'],
...
'<b>' + 'In each of the following sentences a group of words has been underlined. Choose from the alternatives lettered A to D the one that best explains the underlined words.' + '</b>' + '<br />' + '<br />' + 
'Fatima warned her brother that his friend had ' + '<u>' + 'a loose tongue' + '</u>' + '<br />' +' This means his friend',
options: ['could not keep quiet',
...
'<b>' + 'In each of the following sentences a group of words has been underlined. Choose from the alternatives lettered A to D the one that best explains the underlined words.' + '</b>' + '<br />' + '<br />' + 
'When I went to Accra Mr Asah ' + '<u>' + 'put me up' + '</u>' + ' for the night.' + '<br />' + 'This means Mr Asah',
options: ['received me',
...
'Everybody was happy because we had a ' + '<u>' + 'fruitful' + '</u>' + ' discussion.',
options: ['long',
 'useless',
 'short',
 'frank'],
...
'<b>' + 'From the list of words lettered A to D, choose the one that is most nearly opposite in meaning to the word underlined in each sentence' + '</b>' + '<br />' + '<br />' +
'Abiola complained that the work was ' + '<u>' + 'tedious.' + '</u>',
options: ['boring ',
 'dirty ',
 'good ',
 'easy'],
...
'<b>' + 'From the list of words lettered A to D, choose the one that is most nearly opposite in meaning to the word underlined in each sentence' + '</b>' + '<br />' + '<br />' +
'The students rushed towards the nearest ' + '<u>' + 'entrance.' + '</u>',
options: ['closure',
 'opening',
 'exit',
 'departure'],
...
'<b>' + 'From the list of words lettered A to D, choose the one that is most nearly opposite in meaning to the word underlined in each sentence' + '</b>' + '<br />' + '<br />' +
'I believe that Fusena is ' + '<u>' + 'guilty' + '</u>' + ' of the crime.',
options: ['ignorant',
 'aware',
 'innocent',
 'careless'],
...
'<b>' + 'From the list of words lettered A to D, choose the one that is most nearly opposite in meaning to the word underlined in each sentence' + '</b>' + '<br />' + '<br />' +
'Mrs. Addo is our ' + '<u>' + 'hostess' + '</u>' + ' for the show.',
options: ['guest',
 'speaker',
 'guide',
 'sponsor'],
