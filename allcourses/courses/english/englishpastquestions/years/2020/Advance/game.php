...
<div class="container">
  <div id="game" class="justify-center flex-column">
    <div id="hud">
     ...
     <div class="popup" onclick="myFunction()"><span style="font-size: 2.5rem;">BECE 2020 &nbsp; &nbsp;Extract &nbsp; &nbsp; <span style="font-size: 2.5rem;"><a href="../index.php" class="Exit">Exit</a></span></span>
     <span class="popuptext" id="myPopup">
    
    	<center><span style="font-size: 1.5rem; ">Extract I </span></center><br />
<p style="font-size: 1.5rem">
&nbsp;   The sudden change in the weather frightened Araba.<br />
