...
<div class="container">
  <div id="game" class="justify-center flex-column">
    <div id="hud">
     ...
     <div class="popup" onclick="myFunction()"><span style="font-size: 2.5rem;">BECE 2016 &nbsp; &nbsp;Extract &nbsp; &nbsp; <span style="font-size: 2.5rem;"><a href="../index.php" class="Exit">Exit</a></span></span>
...
&nbsp;How would she get home if the worst happened?<br />
    </p></span></div>
            </div>
