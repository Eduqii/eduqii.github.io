...
'How much change was he given?',
	...
	{
		question: 'Arrange the following integers from the least to the highest – 4, 9, – 10, – 7 and 2.',
		options: ['–10, –7, –4, 2, 9',
		 ' –10, 9, –7, –4, 2',
		 ' –4, –7, –10, 2, 9',
		 '2, –4, –7, 9, –10'],
	...
	{
		question: 'Simplify: (46 × 102) + (102 × 54)',
		options: ['1,020',
		 '10,200',
		 '102,000',
		 '1,020,000'],
	...
	{
		question: 'The table shows the marks of some students in a test.' + '<br />' + '<br />' + '<table>' +
	...
	{
		question: 'The figure QPR is an equilateral triangle. If angle PRS = (2x – 10\xB0), find the value of x.',
		options: ['55\xB0',
		 '65\xB0',
		 ' 85\xB0',
		 '95\xB0'],
	...
	{
		question: 'The point P (– 3, 7) is reflected in the x-axis. Find its image.',
		options: ['(–3, –7)',
		 ' (–3, 7)',
		 '(–7, 3)',
		 '(3, –7)'],
