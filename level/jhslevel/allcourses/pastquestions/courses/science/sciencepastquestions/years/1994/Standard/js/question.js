...
options: ['is larger than the sun',
...
options: ['Thepivotis between theeffort and the load ',
 'The load is between the effort and the pivot ',
 'Thereis no pivot',
 'Theload is on thepivot',
...
options: ['is made from sugarand flour',
 'is digested into simplesugar',
 'mixes with salivawhich is alkaline',
...
options: ['The load distance is equal to the effort distance',
...
options: ['Storestarch in theswollenbranch roots',
 'Takein air for respiration',
...
{
question: 'Which ofthe followingis the energypossessed byan object placed on atable?',
options: ['Kinetic energy',
 'Electrical energy ',
 'Potential energy ',
 'Sound energy',
...
options: ['clouds covering the moon surface',
 'earth revolving aroundthe sun',
...
options: ['transported in soluble form within the body of animals',
 'broken down into tiny pieces in the mouth',
 'moved through the alimentary canal',
 'broken down to produceenergy, waterand carbondioxide',
...
options: ['Glucose and oxygen',
 'Waste food, energyand carbondioxide',
 'Energy, carbon dioxide and water',
 'Energy, oxygenand water',
