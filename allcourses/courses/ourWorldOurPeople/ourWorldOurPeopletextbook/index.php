...
<html lang="en">
  <head>
    ...
    <title>Our World Our People TextBook · Eduqii v2.0</title>
...
<header class="bd-header bg-dark py-3 d-flex align-items-stretch border-bottom border-dark">
  <div class="container-fluid d-flex align-items-center">
    ...
    <!--<a href="../sspastquestions/years/index.php" class="ms-auto link-light" hreflang="ar" target="_blank">Past Questions</a>-->
  </div>
</header>
<aside class="bd-aside sticky-xl-top text-muted align-self-start mb-3 mb-xl-5 px-2">
  <h2 class="h6 pt-4 pb-3 mb-4 border-bottom">On this page</h2>
  <h2 class="h6 pt-4 pb-3 mb-4"><a style="cursor: pointer;" title="EduqiiDictionary" alt="EduqiiDictionary">Dictionary</a></h2>
  <h2 class="h6 pt-4 pb-3 mb-4 border-bottom"><a>Contents</a></h2>
