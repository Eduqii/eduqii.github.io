...
<div class="container">
  <div id="game" class="justify-center flex-column">
    <div id="hud">
     ...
     <div class="popup" onclick="myFunction()"><span style="font-size: 2.5rem;">BECE 2011 &nbsp; &nbsp;Extract &nbsp; &nbsp; <span style="font-size: 2.5rem;"><a href="../index.php" class="Exit">Exit</a></span></span>
