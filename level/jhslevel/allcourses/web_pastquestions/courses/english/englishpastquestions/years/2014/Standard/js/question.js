...
const quiz = [
  {
  	question: '<b>' + 'From the alternatives lettered A to D, choose the one which most suitably completes each sentence.' + '</b>' + '<br />' + '<br />' + 'The students were hostile _______ the lazy teacher.',
  	options:['on',
			 'to',
			 'from',
			 'with'],
  ...
  {	
  	question: '<b>' + 'From the alternatives lettered A to D, choose the one which most suitably completes each sentence.' + '</b>' + '<br />' + '<br />' + 'The _______ met at the mess.',
  ...
  {
  	question: '<b>' + 'From the alternatives lettered A to D, choose the one which most suitably completes each sentence.' + '</b>' + '<br />' + '<br />' + 'The workers are demonstrating ________ management.',
  	options:['at',
			 'on',
			 'upon',
			 'against'],
  ...
  {
  	question: '<b>' + 'From the alternatives lettered A to D, choose the one which most suitably completes each sentence.' + '</b>' + '<br />' + '<br />' + ' _______ failed the examination, Doris was dismissed from the school.',
  	options:[ 'Having',
			  'In having',
			  'On having',
			  'To having'],
  ...
  {
  	question: '<b>' + 'From the alternatives lettered A to D, choose the one which most suitably completes each sentence.' + '</b>' + '<br />' + '<br />' + 'The building he bought ________ millions of cedis.',  	
  	options:[ 'cost',
			  'costs',
			  'costed',
			  'costing'],
  ...
  {
  	question: '<b>' + 'From the alternatives lettered A to D, choose the one which most suitably completes each sentence.' + '</b>' + '<br />' + '<br />' + 'The dresses are _______ .',		
  	options: ['you',
			  'your\'s',
			  'our\'s',
			  'ours'],
  ...
  {
  	question: '<b>' + 'From the alternatives lettered A to D, choose the one which most suitably completes each sentence.' + '</b>' + '<br />' + '<br />' + 'We shall invite him when he ________ from America.',	 
  	options: [ 'will return',
			   'had returned',
			   'returns',
			   'returned'],
  ...
  {
  	question: '<b>' + 'From the alternatives lettered A to D, choose the one which most suitably completes each sentence.' + '</b>' + '<br />' + '<br />' + 'The students were congratulated ________ their brilliant performance.',		
  	options: [ 'by',
			   'on',
			   'with',
			   'about'],
  ...
  {
  	question: '<b>' + 'From the alternatives lettered A to D, choose the one which most suitably completes each sentence.' + '</b>' + '<br />' + '<br />' + 'By this time next year, I ________ school.',		
  	options: ['will leave',
			  'would leave',
			  'might leave',
			  'will have left'],
  ...
  {
  	question: '<b>' + 'From the alternatives lettered A to D, choose the one which most suitably completes each sentence.' + '</b>' + '<br />' + '<br />' + 'Isn\'t that girl ________ old to play with toys?',		
  	options: ['as',
			  'so',
			  'too',
			  'very'],
  ...
  {
  	question: '<b>' + 'From the alternatives lettered A to D, choose the one which most suitably completes each sentence.' + '</b>' + '<br />' + '<br />' + 'You usually come to school early, _______ ?',		
  	options: ['can you',
			  'will you',
			  'aren\'t you',
			  'don\'t you'],
  ...
  {
  	question: '<b>' + 'From the alternatives lettered A to D, choose the one which most suitably completes each sentence.' + '</b>' + '<br />' + '<br />' + 'I am ________ faithfully.',
		options: ['your',
				  'yours\'',
				  'yours',
			  	  'your\'s'],
  ...
  {
  	question: '<b>' + 'From the alternatives lettered A to D, choose the one which most suitably completes each sentence.' + '</b>' + '<br />' + '<br />' + 'No sooner had we arrived _______ he came back from work.',		
  	options: ['than',
			  'then',
			  'when',
			  'before'],
  ...
  {
  	question: '<b>' + 'From the alternatives lettered A to D, choose the one which most suitably completes each sentence.' + '</b>' + '<br />' + '<br />' + 'Kofi and Ama love _______ .',		
  	options: ['another',
			  'theirselves',
			  'each other',
			  'one another'],
  ...
  {
  	question: '<b>' + 'From the alternatives lettered A to D, choose the one which most suitably completes each sentence.' + '</b>' + '<br />' + '<br />' + 'It\'s no good _______ to him.',		
  ...
  {
  	question: '<b>' + 'From the alternatives lettered A to D, choose the one which most suitably completes each sentence.' + '</b>' + '<br />' + '<br />' + 'Since our last meeting, I _____ ill.',		
  	options: ['am',
			  'was',
			  'had been',
			  'have been'],
  ...
  {
  	question: '<b>' + 'From the alternatives lettered A to D, choose the one which most suitably completes each sentence.' + '</b>' + '<br />' + '<br />' + 'I was _______ tired that I couldn\'t go any further.',		
  	options: ['so',
			  'too',
			  'much',
			  'very'],
  ...
  {
  	question: '<b>' + 'From the list of words lettered A to D, choose the one that correctly answers the questions or completes the sentence.' + '</b>' + '<br />' + '<br />' + 'The dominant idea in a literary work constitutes its _______ .',		
  	options: ['plot',
			  'theme',
			  'diction',
			  'structure'],
  ...
  {
  	question: '<b>' + 'From the list of words lettered A to D, choose the one that correctly answers the questions or completes the sentence.' + '</b>' + '<br />' + '<br />' + 'The expression \"The world is a stage.\" is an example of _______ ',		
  	options: ['metonymy',
			  'simile',
			  'personification',
			  'metaphor'],
  ...
  {
  	question: '<b>' + 'From the list of words lettered A to D, choose the one that correctly answers the questions or completes the sentence.' + '</b>' + '<br />' + '<br />' + 'A genre is ________ ',		
...
'Sleep whispers softly and strong' + '<br />' + '<br />' + 'The device used in \"Sleep comes gently and strong\" is _____ ',
		options: ['irony',
				  'hyperbole',
				  'euphemism',
				  'personification'],
...
'Tiny legs kick with pleasure'+ '<br />' + 
'Sleep comes gently and strong' + '<br />' +
'Sleep whispers softly and strong' + '<br />' + '<br />' + 'The rhyme scheme of the stanza is _______ ',		
  	options: ['abba',
			  'bbaa',
			  'aabb',
			  'abab'],
...
'Into the silent sea.' + '<br />' + '<br />' + 'The ' + '<b>' + 'main' + '</b>' + ' sound device used in the stanza is _______ .',
		options: ['pun',
				  'rhyme',
				  'alliteration',
				  'onomatopoeia'],
...
'The furrow followed free' + '<br />' + 
'We were the first that burst' + '<br />' + 
'Into the silent sea.' + '<br />' + '<br />' + 'The device helps to express ________ ',
