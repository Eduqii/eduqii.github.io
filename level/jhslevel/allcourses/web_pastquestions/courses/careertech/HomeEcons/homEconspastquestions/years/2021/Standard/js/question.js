...
const quiz = [
  ...
  },
  {
  	...
  	options:['Flower', ' Seed',' Manure',' Plantain'],
  	answer:2
  },
  {
  	question:'The first thing to do when you want to clean a refrigerator is to.....',
  	options:[ 'Switch on','Remove ice trays','Defrost','Remove its contents'],
  	answer:2
  },
  {
  	question:'In the kitchen arrangement, the sink should be near the window for....',
  	options:[ 'Ventilation and walk','Light and ventilation','Light and walk','Size of cook'],
  	answer:1
  },
  {
  	question: 'The best method used in preserving food nutrients, while cooking is by....',
		options: ['Frying','Baking','Steaming','Roasting'],
		answer: 2
  },
  {
  	question: '...... is a natural fibers that costs a lot.',
	  options: [ 'Wool',' Silk','Rayon','Cotton'],
		answer: 0
  },
  {
  	question: 'A well groomed person has .....',
		options: [ 'Well groomed hair','A neat and clean body','A neat and clean appearance','Well groomed hair and nails'],
		answer: 2
  },
  {
  	question: 'One of the following parts of the body is used for smelling',
		options: ['Hands','Mouth','Tongue','Nose'],
		answer: 3
  },
  {
  	question: 'One of these is not a description of an aerobic exercise.',
		options: ['Sit-ups','Cycling','Running','Jogging'],
		answer: 0
  },
  {
  	question: 'Exercise is a ........',
		options: ['Mental movement','Body movements','Physical movement','Walking movement'],
		answer: 2
  },
  {
  	question: 'Stretching exercises are done to ......',
		options: ['Develop muscles','Be healthy','Strengthen the heart','Firm the muscles'],
		answer: 3
  },
  {
  	question: 'Crossway strips are also called ......',
		options: ['Binding strips','Warp','Bias','Weft'],
		answer: 2
  },
  {
  	question: 'The first step in the application of makeup is to.....',
		options: ['Tone the face','Moisturise the face',' Cleanse the face','Powder the face'],
		answer: 2
  },
  {
  	question: 'The following are used in making up the face except.......',
		options: ['Skin tonic','Face powder','Foundation cream','Cleansing lotion'],
		answer: 3
  },
  {
  	question: 'The provision of the basic family needs is the role of....',
		options: ['Mother','Father, mother and children','Children','Father'],
		answer: 3
  },
  {
  	question: 'Which of the following is a transmitted disease?',
		options: ['Hypertension','Gonorrhea','Headache','Hearing impairment'],
		answer: 1
  },
  {
  	question: 'Which of the following fibres is of natural source',
		options: ['Acrylics','Polyester','Nylon','Silk'],
		answer: 3
  },
  {
  	question: 'Which of the following is not a floor covering?',
		options: ['Terrazzo','Mat','Linoleum','Rug'],
		answer: 0
  },
  {
  	question: '..... is for healthy teeth?',
		options: ['Flouride','Nutrient','Chloride','Protein'],
		answer: 0
  },
  {
  	question: 'Food stuffs that could be stored for a long period are called......',
		options: ['Perishable','Non-protected','Protective','Non-perishable'],
		answer: 3
  },
  {
  	question: 'Your siblings son is your........',
		options: ['Niece','Cousin','Nephew','Brother'],
		answer: 2
  },
  {
  	question: 'Needle used for embroidery are known as......',
		options: ['Crewel','Betweens','Sewing needles','Darning needles'],
		answer: 0
  },
  {
  	question: 'The best methd of coooking an invalid dishes is......',
		options: ['Boiling','Baking','Stewing','Steaming'],
		answer: 3
  },
  {
  	question: 'A broken marriage is also referred to as ......',
		options: ['Engagement','Divorce','Crisis','Reunion'],
		answer: 1
  },
  {
