...
const quiz = [
  {
...

	{
		...
		options: ['CD, DVD, Floppy Disk and Hard Disk',
				  'Floppy Disk, Hard Disk, DVD and CD',
				  'Floppy Disk, CD, DVD and Hard Disk',
				  'Floppy Disk, DVD, CD and Hard Disk'],
		answer: 2
	},

	{
		question: 'A pen drive',		
		options: ['inputs information',
...

	{
		...
		options: ['shut down the computer',
...

	{
		...
		options: ['cut the file from the desktop',
				  'delete the file into recycle bin',
				  'make a duplicate of the file',
				  'remove the file from a folder'],
		answer: 2
	},
...

	{
		...
		options: ['creates a new document',
				  'opens a file menu',
				  'opens a new window',
...

	{
		...
		options: ['click on the formatting button',
				  'click the shortcut mouse button',
				  'save the document',
