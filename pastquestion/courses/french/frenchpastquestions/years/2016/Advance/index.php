...
<div id="home" class="flex-column flex-center">
	<h5>Instruction: <br /> This quiz contains two passages (Passage I - Deux amis malheureux and Passage II - Le cycliste ). To read, click on the passage icon below to toggle it.</h5>
	<h1>Are you Ready?</h1>
