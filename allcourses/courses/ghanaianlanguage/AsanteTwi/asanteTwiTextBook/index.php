...
<html lang="en">
  <head>
    ...
    <title>Ghanaian Language - Asante Twi TextBook · Eduqii v2.0</title>
...
<header class="bd-header bg-dark py-3 d-flex align-items-stretch border-bottom border-dark">
  <div class="container-fluid d-flex align-items-center">
    ...
    <a href="../asantetwipastquestions/years/index.php" class="ms-auto link-light" hreflang="ar">Past Questions</a>
  </div>
</header>
