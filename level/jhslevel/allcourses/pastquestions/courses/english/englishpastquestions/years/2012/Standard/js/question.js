...
const quiz = [
  {
  	question: '<b>' + 'From the alternatives lettered A to D, choose the one which most suitably completes each sentence' + '</b>' + '<br />' + '<br />' + 'Two people perished ________ the spot.',
  	options:['upon',
			 'in',
			 'on',
			 'through'],
  ...
  {	
  	question: '<b>' + 'From the alternatives lettered A to D, choose the one which most suitably completes each sentence' + '</b>' + '<br />' + '<br />' + 'Oyo fell ill _______ measles.',
	options:[ 'at',
			  'by',
			  'of',
			  'with'],
  ...
  {
  	question: '<b>' + 'From the alternatives lettered A to D, choose the one which most suitably completes each sentence' + '</b>' + '<br />' + '<br />' + 'The doctor gave ________ to the patient.',  	
  ...
  {
  	question: '<b>' + 'From the alternatives lettered A to D, choose the one which most suitably completes each sentence' + '</b>' + '<br />' + '<br />' + 'All girls were supposed to wear ________ during the Speech Day.',
  ...
  {
  	question: '<b>' + 'From the alternatives lettered A to D, choose the one which most suitably completes each sentence' + '</b>' + '<br />' + '<br />' + '‘I think you know ________ already\', said the host to all the participants.',
		options: ['one another',
				  'each other',
				  'themselves',
				  'ourselves'],
  ...
  {
  	question: '<b>' + 'From the alternatives lettered A to D, choose the one which most suitably completes each sentence' + '</b>' + '<br />' + '<br />' + 'Children usually take ________ their parents in appearance.',
		options: [ 'after',
				   'from',
				   'to',
				   'up'],
  ...
  {
  	question: '<b>' + 'From the alternatives lettered A to D, choose the one which most suitably completes each sentence' + '</b>' + '<br />' + '<br />' + 'We haven\'t had ________ rice to eat this week.',
		options: ['some',
				  'little',
				  'any',
				  'many'],
  ...
  {
  	question: '<b>' + 'From the alternatives lettered A to D, choose the one which most suitably completes each sentence' + '</b>' + '<br />' + '<br />' + 'The chief praised the ________ during the students demonstration.',
  ...
  {
  	question: '<b>' + 'From the alternatives lettered A to D, choose the one which most suitably completes each sentence' + '</b>' + '<br />' + '<br />' + 'When the lights went off I _______ my supper.',
		options: ['have eaten',
				  'have been eating',
				  'am eating',
				  'was eating'],
  ...
  {
  	question: '<b>' + 'From the alternatives lettered A to D, choose the one which most suitably completes each sentence' + '</b>' + '<br />' + '<br />' + 'The doctor said she ________ if she had not kept strictly to her diet.',
		options: ['has died',
				  'will die',
				  'would die',
				  'would have died'],
  ...
  {
  	question: '<b>' + 'From the alternatives lettered A to D, choose the one which most suitably completes each sentence' + '</b>' + '<br />' + '<br />' + 'We saw the plane ________ for Kumasi',		
  	options: [' take on',
			  'take of',
			  'take off',
			  'take out'],
  ...
  {
  	question: '<b>' + 'From the alternatives lettered A to D, choose the one which most suitably completes each sentence' + '</b>' + '<br />' + '<br />' + 'There are many big houses in our area, _______ .?',
		options: ['isn\'t it',
				  'aren\'t they',
				  'weren\'t there',
		  		   'aren\'t there'],
  ...
  {
  	question: '<b>' + 'From the alternatives lettered A to D, choose the one which most suitably completes each sentence' + '</b>' + '<br />' + '<br />' + 'You have cut the grass, _______ ?',		
  	options: ['haven\'t you',
			  'did you',
			  'didn\'t you',
			  'had you'],
  ...
  {
  	question: '<b>' + 'From the alternatives lettered A to D, choose the one which most suitably completes each sentence' + '</b>' + '<br />' + '<br />' + 'The new airport ________ next year.',		
  ...
  {
  	question: '<b>' + 'From the alternatives lettered A to D, choose the one which most suitably completes each sentence' + '</b>' + '<br />' + '<br />' + 'Walking in the rain is not good, ________ ?',		
  	options: ['is not',
			  'is it',
			  'must not',
			  'must it'],
  ...
  {
  	question: '<b>' + 'From the alternatives lettered A to D, choose the one which most suitably completes each sentence' + '</b>' + '<br />' + '<br />' + 'Go over your work carefully, _______  you?',		
  	options: ['do',
			  'will',
			  'may',
			  'shall'],
  ...
  {
  	question: '<b>' + 'In each of the following sentences a group of words has been underlined. Choose from the alternatives lettered A to D the one that best explains the underlined group of words.' + '</b>' + '<br />' + '<br />' + 'Awuni normally ' + '<u>' + 'feels at home' + '</u>' + ' in my house. This means that Awuni ________ in my house.',		
  ...
  {
  	question: '<b>' + 'From the options lettered A to D, choose the one that correctly answers the questions or completes the sentence' + '</b>' + '<br />' + '<br />' + 'The main idea in a novel or play is the ________ ',
  	options: ['suspense',
			  'plot',
			  'gist',
			  'theme'],
  ...
  {
  	question: '<b>' + 'From the options lettered A to D, choose the one that correctly answers the questions or completes the sentence' + '</b>' + '<br />' + '<br />' + 'The three main forms of literature are prose, drama and _______',
		options: ['novel',
				  'satire',
				  'poetry',
				  'prosody'],
  ...
  {
  	question: '<b>' + 'Read the following stanza and answer this question' + '</b>' + '<br />' + '<br />' + 'Time, like an ever-rolling stream,' + '<br />' + 'Bears all its sons away.' + '<br />' + 'They fly forgotten, as a dream' + '<br />' + 'Dies at the opening day.' + '<br />' + '<br />' + 'Time in the stanza is being used as ________ ',		
  	options: ['symbol',
			  'simile',
			  'synecdoche',
			  'personification'],
  ...
  {
  	question: '<b>' + 'Read the following stanza and answer this question' + '</b>' + '<br />' + '<br />' + 'Time, like an ever-rolling stream,' + '<br />' + 'Bears all its sons away.' + '<br />' + 'They fly forgotten, as a dream' + '<br />' + 'Dies at the opening day.' + '<br />' + '<br />' + 'The rhyme scheme of the stanza is ________ ',  	
  	options: ['abba',
			  'bbaa',
			  'abab',
			  'baba'],
  ...
  {
  	question: 'The place and time of the action of a play or novel is its ________ ',		
  	options: ['background',
			  'setting',
			  'scene',
			  'atmosphere'],
  ...
  {
  	question: ' The main function of imagery in literature is to make readers / listeners ________ ',
  ...
  {
  	question: 'A character in a play that opposes the hero or heroine is the ________',
  	options: ['antagonist',
			  'challenger',
			  'opponent',
			  'protagonist'],
